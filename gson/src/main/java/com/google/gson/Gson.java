...
import com.google.gson.internal.bind.JsonSnippetTypeAdapter;
...
public final class Gson {
  ...
  Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy,
    ...
    factories.add(new RecordTypeAdapterFactory(constructorConstructor, fieldNamingStrategy, excluder, jsonAdapterFactory, reflectionFilters));
    factories.add(TypeAdapters.newFactory(TypeToken.get(JsonSnippet.class), new JsonSnippetTypeAdapter()));
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
    ...
    try {
      ...
      for (TypeAdapterFactory factory : factories) {
        ...
        if (candidate != null) {
          @SuppressWarnings("unchecked")
          TypeAdapter<T> existingAdapter = (TypeAdapter<T>) typeTokenCache.get(type);
