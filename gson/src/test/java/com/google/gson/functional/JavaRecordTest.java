...
public final class JavaRecordTest {
  ...
  public void recursiveRecords() {
    verifyJSON(
        Recursive.class, new Recursive("abcd", new Recursive("text", new Recursive("xxx", null))));
  ...
  public void genericRecords() {
    verifyJSON(
        ...
        new Generic(
            "xxx",
            List.of(
                new Nested("abcd", new Simple("text1", 1234L)),
            ...
            Map.of(
                "a",
                    new Generic(
                        "xxx1",
                        List.of(
                            new Nested("abcd1", new Simple("text1", 1234L)),
                            new Nested("efgh1", new Simple("text2", 5678L)))),
                "b",
                    new Generic(
                        "xxx2",
                        List.of(
                            new Nested("abcd2", new Simple("text3", 4321L)),
  ...
  public void parameterizedRecords() {
    verifyJSON(
        TypeToken.getParameterized(Parameterized.class, String.class, String.class).getType(),
        new Parameterized<>("string", List.of("1234", "2345")));
    verifyJSON(
        TypeToken.getParameterized(Parameterized.class, String.class, Simple.class).getType(),
        new Parameterized<>(new Simple("abcd", 12), List.of("1234", "2345")));
    verifyJSON(
        TypeToken.getParameterized(Parameterized.class, Simple.class, String.class).getType(),
